...
- **[MegaLaunch MCP](https://github.com/jacksun911/megalaunch-mcp)** – AI-powered meme token launch on Solana/pump.fun via MCP. 6 tools: create orders, check status, get pricing. One-command install: `npx megalaunch-mcp`. Glama A/A/A rated.
- **[MegaSwap MCP](https://github.com/jacksun911/megaswap-mcp)** – AI-native DEX on MegaETH. 9 tools for token swaps, price quotes, liquidity management. Supports ETH, MEGAS, USDM, USDT0 and any ERC-20. `npx megaswap-mcp`
