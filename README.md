...
- **[PolicyLayer MCP](https://www.npmjs.com/package/@policylayer/mcp)** – Non-custodial **spending controls for AI agent wallets**. Enforce daily limits, per-transaction caps, and recipient whitelists on crypto transactions across Ethereum, Base, and Solana.
