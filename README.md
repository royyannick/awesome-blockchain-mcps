...
- **[Clicks Protocol MCP](https://github.com/clicks-protocol/clicks-protocol)** – Autonomous yield for AI agent treasuries on Base. Auto-splits USDC 80/20, routes to best APY (Morpho/Aave V3). 9 MCP tools: query yields, simulate splits, check agent status, referral stats. [npm](https://www.npmjs.com/package/@clicks-protocol/mcp-server) | [HTTP](https://clicks-mcp.rechnung-613.workers.dev/mcp)
