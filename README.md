...
- **[Hashgraph Online (HOL)](https://github.com/hashgraph-online)** – Universal agentic registry on Hedera providing agent discovery, identity (UAIDs), and trustless P2P communication. Bridges A2A, ERC-8004, x402, Virtuals, and MCP protocols. Open-source SDKs: TypeScript, Go, Python.
---
